...
dashboard_routes = [
    ...
    url(r'^healthprovider_plans_edit/(?P<pk>\d+)/healthprovider_plans_edit/$', views.healthprovider_plans_edit, name='healthprovider_plans_edit'),
    url(r'^healthprovider_plans_delete/healthprovider_plans_delete/(?P<pk>\d+)/$', views.healthprovider_plans_delete, name='healthprovider_plans_delete'),
    ...
    # new routes
    url(r'^$', views.new_home, name='dashboard_home'),  # remove new later
